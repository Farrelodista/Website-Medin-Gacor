...
export default function ProgramSection() {
  ...
  const mainProgram = {
    title: 'Company Profile HMTI UNS 2025',
    ...
    videoId: 'nN7QqxjhiQA', // ID YouTube yang benar (tanpa parameter)
    thumbnail: 'https://img.youtube.com/vi/nN7QqxjhiQA/maxresdefault.jpg',
        ...
        <FloatUp>
          <div className="text-center mb-12">
            <div className="inline-flex items-center gap-2 bg-primary/10 px-6 py-2 rounded-full mb-4">
              ...
              <span className="text-primary font-semibold">Cek video di bawah !</span>
            </div>
            <h2 className="text-4xl md:text-5xl font-bold text-foreground mb-4">
              COMPANY PROFIL HMTI UNS 2025
            </h2>
            <p className="text-foreground/70 text-lg max-w-2xl mx-auto">
              Company Profile HMTI UNS 2025 memperkenalkan perjalanan, visi, serta nilai dasar kami: Inklusif, Adaptif, Kolaboratif. 
            </p>
          </div>
        </FloatUp>
